...
import frc.robot.commands.ActiveGrabber.ActiveGrabberMotor;
...
//    private final Arm m_Arm = new Arm();
    ...
    private final ActiveGrabberSubsystem ags = new ActiveGrabberSubsystem();
...
//        new Trigger(new JoystickButton(m_operatorController, XboxController.Button.kA.value)).whileTrue(new ActiveGrabberMotor(ags, 0.5));
        new JoystickButton(m_operatorController, XboxController.Button.kA.value).whileTrue(new ActiveGrabberMotor(ags, 0.75));
        new JoystickButton(m_operatorController, XboxController.Button.kB.value).whileTrue(new ActiveGrabberMotor(ags, -0.75));
